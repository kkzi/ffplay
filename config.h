...
#define FFMPEG_CONFIGURATION                                                                                                                                   \
    "--prefix='D:/Code/vcpkg.2024.09.30/packages/ffmpeg_x64-windows/debug' --toolchain=msvc --enable-pic --disable-doc --enable-debug "                        \
    "--enable-runtime-cpudetect --disable-autodetect --target-os=win32 --enable-w32threads --enable-d3d11va --enable-d3d12va --enable-dxva2 "                  \
    "--enable-mediafoundation --disable-inline-asm --cc=cl.exe --host_cc=cl.exe --cxx=cl.exe --windres=rc.exe --ld=link.exe --ar='ar-lib lib.exe' "            \
    "--ranlib=':' --disable-ffmpeg --disable-ffplay --disable-ffprobe --enable-avcodec --enable-avdevice --enable-avformat --enable-avfilter "                 \
    "--disable-postproc --enable-swresample --enable-swscale --disable-alsa --disable-amf --disable-libaom --disable-libass --disable-avisynth "               \
    "--disable-bzlib --disable-libdav1d --disable-libfdk-aac --disable-libfontconfig --disable-libharfbuzz --disable-libfreetype --disable-libfribidi "        \
    "--disable-iconv --disable-libilbc --disable-lzma --disable-libmp3lame --disable-libmodplug --disable-cuda --disable-nvenc --disable-nvdec "               \
    "--disable-cuvid --disable-ffnvcodec --disable-opencl --disable-opengl --disable-libopenh264 --disable-libopenjpeg --disable-libopenmpt "                  \
    "--disable-openssl --enable-schannel --disable-libopus --disable-sdl2 --disable-libsnappy --disable-libsoxr --disable-libspeex --disable-libssh "          \
    "--disable-libtensorflow --disable-libtesseract --disable-libtheora --disable-libvorbis --disable-libvpx --disable-libwebp --disable-libx264 "             \
    "--disable-libx265 --disable-libxml2 --disable-zlib --disable-libsrt --disable-libmfx --enable-cross-compile --disable-static --enable-shared "            \
    "--extra-cflags='-DHAVE_UNISTD_H=0' --pkg-config='D:/Code/vcpkg.2024.09.30/downloads/tools/msys2/1e74ca60daa10104/mingw64/bin/pkg-config.exe' "            \
    "--disable-optimizations --extra-ldflags='-libpath:D:/Code/vcpkg.2024.09.30/installed/x64-windows/debug/lib' --arch=x86_64 --enable-asm --enable-x86asm"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2024
#define FFMPEG_DATADIR "D:/Code/vcpkg.2024.09.30/packages/ffmpeg_x64-windows/debug/share/ffmpeg"
#define AVCONV_DATADIR "D:/Code/vcpkg.2024.09.30/packages/ffmpeg_x64-windows/debug/share/ffmpeg"
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.29.30156 for x64"
